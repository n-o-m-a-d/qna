...
//$address = "sajith1991sep@gmail.com";
...
$query1 = "SELECT * FROM email_list WHERE email = '$email'";
$data1 = mysqli_query($dbc,$query1) or die('Error querying database');
...
{
	echo 'You are already subscribed to updates.';
	exit();
}
/*
	echo "<fieldset>";
